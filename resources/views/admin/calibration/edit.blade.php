  ...
  <section id="basic-vertical-layouts">
    <div class="row">
      <div class="col-md-8 col-12">
        <div class="card">
          <div class="card-body">
            <form class="form form-vertical" action="{{route('calibrations.update', $calibration)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method("PUT")
              <div class="row">
                <div class="mb-1">
                  ...
                  <div class="mb-1">
                    ...
                    <input type="text" class="form-control @error('interval') is-invalid @enderror" id="interval"
                      name="interval" placeholder="Calibration Interval Date" aria-describedby="calibration-date"
                      value="{{ ($calibration->interval) ?? old('interval') }}" />
                    @error('interval')
                      <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                  ...
                  <div class="mb-1">
                    ...
                    <div class="input-group">
                        <input id="thumbnail" class="form-control" type="text" name="calibrationfile" value="{{$calibration->certificate ?? old('calibrationfile')}}">
                      ...
                      <img id="holder" src="{{$calibration->certificate ?? old('calibrationfile')}}" alt="Thumbnail" style="margin-top:15px;max-height:100px;">
                  </div>
                <div class="col-12">
