...
<div class="container">
    <div class="panel">
        <div class="panel-body wizard-content">
            ...
            <form action="{{route('inspections.update', $inspection)}}" method="post" id="main-form">
                @csrf
                @method("PUT")
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" placeholder="Enter Batch Number" class="form-control"  name="batch_no" value="{{$inspection->batch_no ?? ''}}" id="batch_no" required>
                                    </div>
                                    <div class="mb-1">
